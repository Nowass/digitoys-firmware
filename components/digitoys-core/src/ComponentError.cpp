...
const char* ComponentError::errorToString(esp_err_t err) {
    switch (err) {
        ...
        case ESP_FAIL:                  return "Generic error";
        ...
        case ESP_ERR_NOT_FOUND:        return "Resource not found";
        case ESP_ERR_NOT_SUPPORTED:    return "Operation not supported";
        case ESP_ERR_TIMEOUT:          return "Operation timeout";
